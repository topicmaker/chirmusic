...
/**
 * update 2009.12.07 t-suzuki   : バグ修正、ファイル名を「jquery.flydom-3.1.1.custom.js」に
*/
...
String.prototype.toCamelCase = function()
{
    ...
    var special = { 'class': 'className', 'colspan': 'colSpan', 'rowspan': 'rowSpan', 'for': 'htmlFor', 'httpequiv': 'httpEquiv',
                    ...
                    'accesskey': 'accessKey', 'noshade': 'noShade', 'datetime': 'dateTime', 'usemap': 'useMap',
...
//「'value': 'defaultValue', 」を削除   @t-suzuki
